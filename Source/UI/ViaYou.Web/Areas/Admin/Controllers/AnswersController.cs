...
namespace ViaYou.Web.Areas.Admin.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            data.AvailableQuestions = questions.CreateSelectListItems(q => q.Identifier, q => q.Identifier, q => q.Id == answer.Question?.Id);
        ...
        public ActionResult Edit(AnswerViewModel data)
        {
            ...
            var question = data.QuestionId != null ? _questionRepository.GetBy2Id(data.QuestionId) : null;

            answer.Update(data.Text, question);
            _transactionManager.SaveChanges();
        ...
        public ActionResult Create()
        {
            ...
            {
                AvailableQuestions = questions.CreateSelectListItems(x => x.Identifier, x => x.Identifier, x => false)
            });
        }
        ...
        public ActionResult Create(AnswerViewModel data)
        {
            ...
            {
                Text = data.Text,
                Question = data.QuestionId != null ? _questionRepository.GetBy2Id(data.QuestionId) : null
            });
